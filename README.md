# @hishprorg/voluptatum-aliquam

[![Build Status](https://secure.travis-ci.org/nathanboktae/@hishprorg/voluptatum-aliquam.png)](http://travis-ci.org/nathanboktae/@hishprorg/voluptatum-aliquam)

@hishprorg/voluptatum-aliquam is an extension to the [chai](http://chaijs.com/) assertion library that
...
```
npm install @hishprorg/voluptatum-aliquam
```

### bower

```
bower install @hishprorg/voluptatum-aliquam
```
...
chai.use(require('@hishprorg/voluptatum-aliquam'))
```

### AMD

```javascript
require(['chai', '@hishprorg/voluptatum-aliquam'], function(chai, chaiDom) {
  chai.use(chaiDom)
})
```
...
<script src="@hishprorg/voluptatum-aliquam.js"></script>
```
